<button  class="ui-state-default ui-corner-all fixed-bottom  btn btn-lg btn-info btn-circle  active center" id="animation" data-toggle="tooltip" title="Liste des utilisateurs" ><i class="glyphicon glyphicon-list"></i></button>
